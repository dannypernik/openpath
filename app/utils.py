...
def batch_update_weekly_usage(date_yyyymmddd=None):
    ...
    stats = parse_celery_worker_log('/var/log/supervisor/celery_worker_error.log', week_start, week_end)
...
def get_org_details_dict(organization):
    organization_dict = {
        ...
        'sat_spreadsheet_id': organization.sat_spreadsheet_id,
        'act_spreadsheet_id': organization.act_spreadsheet_id,
